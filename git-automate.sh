...
sudo git clone https://github.com/Iqrazamir1/WordPressProject.git /root/WordPressProject
...
echo "Running lemp-automate.sh script..." | tee -a $LOG_FILE
sudo bash /root/WordPressProject/lemp-automate.sh
check_exit_status "lemp-automate.sh script"
